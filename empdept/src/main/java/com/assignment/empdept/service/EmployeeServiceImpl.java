...
import com.assignment.empdept.repo.DepartmentRepo;
import com.assignment.empdept.repo.EmployeeRepo;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public void populateEmployee() {
		...
		Employee emp = new Employee("ABC",21,1,1,45000);
		Employee emp1 = new Employee("DEF",20,1,1,45000);
		Employee emp2 = new Employee("MNO",22,1,1,45000);
		Employee emp3 = new Employee("PQR",20,1,1,45000);
		Employee emp4 = new Employee("XYZ",22,1,1,45000);
		...
		Department dep3 = new Department("Account","Bangalore");
		Department dep4 = new Department("Test","Bangalore");
